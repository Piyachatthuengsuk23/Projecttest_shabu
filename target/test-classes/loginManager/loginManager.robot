...
Verify Login Page Title
    ...
    ${title}=    Set Variable    Login - Restaurant Management System
    Should Be Equal    ${title}    Login - Restaurant Management System
...
Verify Login Form Action
    [Tags]    Logic
    [Documentation]    Test login submits to LoginManager
